...
Aby uruchomić aplikację z pobranych plików, musisz mieć zainstalowane środowisko **Node.js**:
1. Otwórz terminal (lub wiersz polecenia) w pobranym i rozpakowanym folderze z aplikacją.
2. Wpisz polecenie, aby zainstalować wszystkie wymagane pakiety:
   `npm install`
3. Uruchom serwer developerski wpisując:
   `npm run dev`
4. Aplikacja powinna się uruchomić. W oknie terminala pojawi się link (np. `http://localhost:5173/` lub podobny). Kliknij go lub wklej do przeglądarki.
